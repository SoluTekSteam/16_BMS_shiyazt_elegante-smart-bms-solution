...
if __name__ == "__main__":
    try:
        ...
        client.connect("165.232.177.248", 1883, 60)
        ...
        while True:
            try:
                ...
                payload: dict = {
                    'co2': random.randint(290, 400),
                    'co': random.randint(250, 350),
                    'fireDetection': random.choice(DATA)
                }
                client.publish(topic='api/v1/bms/1LLyEEu0tc98A3/telemetry', payload=json.dumps(payload))
